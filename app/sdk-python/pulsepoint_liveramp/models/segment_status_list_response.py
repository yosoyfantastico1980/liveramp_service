...
class SegmentStatusListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["statuses", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": [SegmentStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None,
