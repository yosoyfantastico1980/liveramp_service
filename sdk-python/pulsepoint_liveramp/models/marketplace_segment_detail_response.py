...
class MarketplaceSegmentDetailResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["segments", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segments": [MarketplaceSegmentDetail.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
